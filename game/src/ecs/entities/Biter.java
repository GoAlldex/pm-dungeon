 ...
 * Hier werden die wichtigesten bestandteile unseres Monsters "Beißer" initialisiert.<br>
 * <br>
 *
...
public class Biter extends Monster {
    ...
    public Biter(int level) {
        ...
        this.hp =
                new HealthComponent(
                        this,
                        Math.round(15f * (1f + ((float) level / 10f) - 0.1f)),
                        this.death,
                        this.hitAnimation,
                        this.dieAnimation);
        this.hitSpeed = 3;
     ...
     * - Wenn das Monster stirbt deaktiviere das Kampfsystem - Gib dem Helden XP - Prüfe ob der Held
     * durch die erhaltene XP ein level aufgestiegen ist, wenn ja setze Nahkampfschaden und HP hoch
     * - Setze einen Blutfleck - Drop ein Item - Entferne das Monster vom Spiel
     *
     * @author Alexey Khokhlov, Michel Witt, Ayaz Khudhur
     * @version cycle_4
     * @since 04.06.2023
    ...
    public void onDeath() {
        this.death =
                entity -> {
                    ...
                    Game.addEntity(
                            WorldItemBuilder.buildWorldItem(item, this.position.getPosition()));
