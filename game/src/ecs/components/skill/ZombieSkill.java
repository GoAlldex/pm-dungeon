...
public class ZombieSkill implements ISkillFunction {
    ...
    public ZombieSkill(
            ArrayList<Zombie> zombies, int level, float dmgZombie, Entity hero, boolean setup) {
    ...
    public void execute(Entity entity) {
        ...
        for (int i = 0; i <= rndInt; i++) {
            ...
            zombieComponent.setIdleAI(
                    entity1 -> {
                        AITools.move(zombie, AITools.calculatePath(zombie, hero));
