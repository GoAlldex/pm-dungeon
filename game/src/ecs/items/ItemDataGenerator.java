...
public class ItemDataGenerator {
    ...
    private static final List<String> potion_world = List.of("animation/Items/Potions/Big_Red_Potion/drop_animation_1.png",
    ...
    private static final List<String> potion_inventory = List.of("animation/Items/Potions/Big_Red_Potion/inventory_icon.png");
    private static final List<String> weapon1_world = List.of("animation/Items/Weapons/Weapons_melee/Weapon_Sword_Blue_1/show.png");
    private static final List<String> weapon1_inventory = List.of("animation/Items/Weapons/Weapons_melee/Weapon_Sword_Blue_1/inventory_icon.png");
    private static final List<String> bag_world = List.of("animation/Items/Bag/show.png");
    private static final List<String> bag_inventory = List.of("animation/Items/Bag/inventory_icon.png");
